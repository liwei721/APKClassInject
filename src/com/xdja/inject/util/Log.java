...
public class Log {
    ...
    public static void learn(Object msg) {
        if (quiet) return;
        if (learnMode) {
            System.out.println("learn: "+ msg);
        }
    }
    ...
    public static String accCode2String(int access) {
       ...
       for (Integer key : map.keySet()){
           if ((key & access) > 0) {
               ...
               builder.append('\\').append(map.get(key)).append('|').append(" ");
           }
       }
                    ...
                    if (obj.getClass().isArray()) {
                        ...
                        if (length > 0) {
                            for (int i = 0; i < length; i++) {
                                Object get = Array.get(obj, i);
                                if (get != null) {
                                    logbuilder.append(get).append("\t");
                                } else {
