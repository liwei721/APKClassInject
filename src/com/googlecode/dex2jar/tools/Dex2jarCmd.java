...
public class Dex2jarCmd extends BaseCmd {
     ...
     *  create by zlw
     *  将dex转成jar
     * @param dexFilePath 要转成jar的dex文件
     *
     */
    public String execDex2jar(String dexFilePath) throws IOException {
        ...
        Path currentDir = dexFile.getParentFile().toPath();
        output = currentDir.resolve(getBaseName(new File(dexFileName).toPath()) + ".jar");
        ...
        if (output != null){
            return output.normalize().toString();
        }
